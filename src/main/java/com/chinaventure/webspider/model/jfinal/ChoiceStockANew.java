...
public class ChoiceStockANew extends Model<ChoiceStockANew>{

	private static final long serialVersionUID = -6057105866308614723L;

	public static final String TableName = JFConfig.getTableName(ChoiceStockANew.class);

	public static ChoiceStockANew dao = new ChoiceStockANew();
	/**
	 * 插入或更新数据
	 * @param bean
	 */
	public void insertOrUpdate(ChoiceEntBeanNew bean) {

		ChoiceStockANew model = new ChoiceStockANew();

...
@Table(name = "xsb_ths_invest_private_placement_plan_completed")
public class XsbThsInvestPrivatePlacementPlanCompleted {
    /**
     * 自增ID
     */
    @Id

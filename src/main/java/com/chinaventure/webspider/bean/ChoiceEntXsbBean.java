...
public class ChoiceEntXsbBean {
	...
	public static String[][] EntItems = {
			...
			//公司简介
			{"info","http://app.jg.eastmoney.com/F9ThirdBoard/GetCompanyIntroductionInfo.do?securityCode={0}&yearList=undefined,undefined&dateSearchType=3&=0&rotate=0&seperate=0&order=desc&cashType=1&exchangeValue=1&customSelect=0",""},
			//曾用名 
			{"name_history","http://app.jg.eastmoney.com/F9ThirdBoard/GetCompanyNameHistoryList.do?securityCode={0}&rotate=0","http://app.jg.eastmoney.com/html_f9_ThirdBoard/companyNameHistory.html?securityCode={0}"},
			//经营分析
			{"ManageAnalysis","http://app.jg.eastmoney.com/html_f9_ThirdBoard/manageAnalysis.html?securityCode={0}",""},
			//简史
			...
			//监事会(现任)	
			{"ManagerInfoType2","http://app.jg.eastmoney.com/F9ThirdBoard/getManagerInfo.do?securityCode={0}&type=2&yearList=undefined,undefined&dateSearchType=3&=0&rotate=1&seperate=0&order=asc&cashType=0&exchangeValue=0",""},
			//高级管理人员(现任)	
			{"ManagerInfoType3","http://app.jg.eastmoney.com/F9ThirdBoard/getManagerInfo.do?securityCode={0}&type=3&yearList=undefined,undefined&dateSearchType=3&=0&rotate=1&seperate=0&order=asc&cashType=0&exchangeValue=0",""},
			//历任管理层成员	

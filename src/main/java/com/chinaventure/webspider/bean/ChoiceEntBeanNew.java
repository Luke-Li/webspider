...
//			{"info","http://app.jg.eastmoney.com/F9Stock/GetCompanyIntroductionInfo.do?securityCode={0}&yearList=undefined,undefined&dateSearchType=3&=0&rotate=0&seperate=0&order=desc&cashType=1&exchangeValue=1&customSelect=0",""},
			...
			//每股指标
			{"EachStockIndex","http://app.jg.eastmoney.com/F9Stock/EachStockIndex.do?securityCode={0}{1}&yearList=2017,2016,2015,2014,2013&reportTypeList=1,5,3,6&dateSearchType=1&=0&rotate=0&seperate=0&order=desc&cashType=0&exchangeValue=0&customSelect=0",""},
			//盈利能力与收益质量
